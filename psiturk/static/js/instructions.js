...
var instructions = [
    ...
    //],
    [
        "In this task, you will observe a video of a physical simulation where two blocks collide with dominoes on a table.<br>",
        "image", "test.png", false, 2
    ],
    // image with target labels (blue)
    [
        "At the beginning of each instance of the task, you will see two blocks, one on the left and the other on the right, "+
            `next to <span style="color:${RED};"><b>red dominoes</b></span> and ` +
            `<span style="color:${BLUE};"><b>blue dominoes</b></span>, respectively.<br>` +
            "Shortly after, the blocks on either end will move towards the center and collide with the dominoes.<br>" +
            "Your task is to determine wether the "  + `<span style="color:${RED};"><b>red</b></span> or` +
            ` <span style="color:${BLUE};"><b>blue</b></span> dominoes are heavy.<br>` +
            "Click <b>Next</b> to see an example video.",
        "image", "test.png", false, 3
    ],
    [
        "", "movie", "12.mp4", false, 0
    ],
    [
        `At the end of each instance of the task, please record your response on the slider presented at the bottom of the screen.<br>` +
            "You will not be able to progress untill you make a selection." +
